...
from MouseDecrypt import load_stylesheet
...
class KeyboardDecryptWindow(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.output.append(
            '由<a href="https://s1rius.space/">s1rius</a>二开\t<a href="https://github.com/Mumuzi7179/UsbKeyboard_Mouse_Hacker_Gui/">源项目(mumuzi)</a>'
        )
    ...
    def run_command(self):
        ...
        try:
            result, result1 = extract_data(type, self.file, self.output)
